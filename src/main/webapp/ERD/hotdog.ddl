...
CREATE TABLE categories(
		...
		ct_img                        		VARCHAR2(50)		 NULL 
);

DROP SEQUENCE categories_ct_no_SEQ;

CREATE SEQUENCE categories_ct_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
